...
public class CustomNestScrollView extends NestedScrollView {
    ...
    public CustomNestScrollView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
        init();
    }

    public CustomNestScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
